				...
				>
					{!isTranslate ? (
						<p className="xl:w-10/12 text-lg lg:text-xl text-left font-sans px-1 pt-4 pb-6 tracking-wide leading-loose">
							...
							, ING is loved by people around the world. Rock Bar
							ING is the go-to venue for the Kyoto nightlife.
							Follow us online and connect with us no matter where
							you are.
						</p>
					) : (
						<p className="xl:w-10/12 text-lg lg:text-xl text-left font-sans px-1 pt-4 pb-4 tracking-wide leading-loose">
							...
							』に掲載され、世界中の人々に愛されているロックバー
							ING
							は、京都のナイトライフの定番スポットです。オンラインで私たちをフォローして、どこにいても私たちとつながりましょう。
						</p>
					)}
				</motion.div>
				<div className="flex justify-center w-full py-3 my-12  border-t-2 border-b-2 border-purple-700 shadow-lg">
					<SocialMediaLinks />
				</div>
			</div>
					...
					{!isTranslate ? (
						<div className="flex justify-end">
							<p className="xl:w-10/12 text-lg lg:text-xl font-sans px-1 py-6 tracking-wide leading-loose">
								Established in 1998, Rock Bar Ing has been an
								vital icon of the Kyoto bar scene. It has played
								an important part of the Kyoto night scene and
								been a local favorite for both Japanese and
								foreign residents alike. It has offered a space
								for those who love good music, a social
								atmosphere, and
