      ...
      <div className="absolute inset-0 flex flex-col justify-between p-4 sm:py-44 md:p-8">
        ...
        <div className="text-center">
          ...
          <div className="pt-8 lg:pt-6 text-2xl">
            <p className="font-shadows py-1 lg:py-3">Open 7 days a week</p>
            <p className="pb-2 lg:pb-3">年中無休</p>
            <p className="font-shadows pt-3">Opening Times: 7pm - 5am</p>
            <p className="pb-2 lg:py-3">営業時間: 19:00～5:00</p>
            <p className="font-sans p-6 sm:px-12 md:p-4 font-bold">
