...
function BarSnacksList() {
  ...
  return (
    <div ref={wrapperRef} className="flex flex-col justify-center items-center">
      <div
        ...
        {isSnacksList && (
          ...
          >
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Japanese Rice Crackers</p>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Edamame / Green Soy Beans</p>
              <div className="flex flex-row">
                <p>枝豆</p>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">World Famous Garlic Festival</p>
              <div className="flex flex-row">
                <p>にんにく祭</p>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Chinese Shrimp Crackers</p>
              <div className="flex flex-row">
                <p>中華えびせんべい</p>
                <p className="pl-3 lg:pl-8">￥400</p>
              </div>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Fried Cheese Sticks</p>
              <div className="flex flex-row">
                <p>チーズ揚げ</p>
                <p className="pl-3 lg:pl-8">￥400</p>
              </div>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Fried Camembert Cheese</p>
              <div className="flex flex-row">
                <p>フライドカマンベールチーズ</p>
                <p className="pl-3 lg:pl-8">￥550</p>
              </div>
            ...
            <div className="flex flex-col justify-center items-center py-4 text-xl font-serif">
              <p className="text-yellow-500">Fried Cream Cheese</p>
              <div className="flex flex-row">
                <p>フライドクリームチーズ</p>
                <p className="pl-3 lg:pl-8">￥550</p>
              </div>
